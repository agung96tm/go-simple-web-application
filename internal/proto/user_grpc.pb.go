...
const (
	...
	UserService_Detail_FullMethodName = "/user.UserService/Detail"
...
type UserServiceClient interface {
	...
	Create(ctx context.Context, in *UserCreateRequest, opts ...grpc.CallOption) (*UserDetailResponse, error)
	Update(ctx context.Context, in *UserUpdateRequest, opts ...grpc.CallOption) (*UserDetailResponse, error)
...
func (c *userServiceClient) Detail(ctx context.Context, in *UserDetailRequest, opts ...grpc.CallOption) (*UserDetailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userServiceClient) Create(ctx context.Context, in *UserCreateRequest, opts ...grpc.CallOption) (*UserDetailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserDetailResponse)
...
func (c *userServiceClient) Update(ctx context.Context, in *UserUpdateRequest, opts ...grpc.CallOption) (*UserDetailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserDetailResponse)
...
type UserServiceServer interface {
	...
	Create(context.Context, *UserCreateRequest) (*UserDetailResponse, error)
	Update(context.Context, *UserUpdateRequest) (*UserDetailResponse, error)
...
func (UnimplementedUserServiceServer) Detail(context.Context, *UserDetailRequest) (*UserDetailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Detail not implemented")
}
func (UnimplementedUserServiceServer) Create(context.Context, *UserCreateRequest) (*UserDetailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedUserServiceServer) Update(context.Context, *UserUpdateRequest) (*UserDetailResponse, error) {
...
func _UserService_Detail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Detail(ctx, req.(*UserDetailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
